...
namespace Terraria.ModLoader.UI
{
	...
	internal class UIModPackItem : UIPanel
	{
		...
		private readonly UIScalingTextPanel<string> _enableListButton;
		private readonly UIScalingTextPanel<string> _enableListOnlyButton;
		private readonly UIScalingTextPanel<string> _viewInModBrowserButton;
		private readonly UIScalingTextPanel<string> _updateListWithEnabledButton;
		...
		public UIModPackItem(string name, string[] mods) {
			...
			var viewListButton = new UIScalingTextPanel<string>(Language.GetTextValue("tModLoader.ModPackViewList")) {
				Width = { Pixels = 100 },
				Height = { Pixels = 36 },
				Left = { Pixels = 407 },
				Top = { Pixels = 40 }
			...
			_enableListButton = new UIScalingTextPanel<string>(Language.GetTextValue("tModLoader.ModPackEnableThisList")) {
				Width = { Pixels = 151 },
				Height = { Pixels = 36 },
				Left = { Pixels = 248 },
				Top = { Pixels = 40 }
			...
			_enableListOnlyButton = new UIScalingTextPanel<string>(Language.GetTextValue("tModLoader.ModPackEnableOnlyThisList")) {
				Width = { Pixels = 190 },
				Height = { Pixels = 36 },
				Left = { Pixels = 50 },
				Top = { Pixels = 40 }
			...
			_viewInModBrowserButton = new UIScalingTextPanel<string>(Language.GetTextValue("tModLoader.ModPackViewModsInModBrowser")) {
				Width = { Pixels = 246 },
				Height = { Pixels = 36 },
				Left = { Pixels = 50 },
				Top = { Pixels = 80 }
			...
			_updateListWithEnabledButton = new UIScalingTextPanel<string>(Language.GetTextValue("tModLoader.ModPackUpdateListWithEnabled")) {
				Width = { Pixels = 225 },
				Height = { Pixels = 36 },
				Left = { Pixels = 304 },
				Top = { Pixels = 80 }
		...
		private void DrawEnabledText(SpriteBatch spriteBatch, Vector2 drawPos) {
			string text = Language.GetTextValue("tModLoader.ModPackModsAvailableStatus", _numMods, _numModsEnabled, _numModsDisabled,
												_numModsMissing);
		...
		private void DeleteButtonClick(UIMouseEvent evt, UIElement listeningElement) {
			...
			string path = UIModPacks.ModListSaveDirectory + Path.DirectorySeparatorChar + modPackItem._filename + ".json";
			if (File.Exists(path)) {
				File.Delete(path);
			}
