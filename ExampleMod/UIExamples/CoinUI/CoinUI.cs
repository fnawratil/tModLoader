using ExampleMod.UIExamples.Inheritance;
...
namespace ExampleMod.UIExamples.CoinUI
{
	...
	{
		// Note: static Visibility on UI is ugly.
		// If you are up for a challenge, try to abstract
		// state of visiblity to a VisibilityUI class and use it here 
		public static bool Visible;

		private DraggableUIPanel _coinCounterPanel;
		private UIMoneyDisplay _moneyDisplay;
		...
		public override void OnInitialize()
		{
			...
			_moneyDisplay = new UIMoneyDisplay();
			_moneyDisplay.Left.Set(15, 0f);
			_moneyDisplay.Top.Set(20, 0f);
			_moneyDisplay.Width.Set(100f, 0f);
			_moneyDisplay.Height.Set(0, 1f);
			_coinCounterPanel.Append(_moneyDisplay);
		...
		{
			_moneyDisplay.Coins += pickedUp;
			_moneyDisplay.AddCoinsPerMinute(pickedUp);
		}
	}
}
